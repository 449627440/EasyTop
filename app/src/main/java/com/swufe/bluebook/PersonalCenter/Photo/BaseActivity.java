...
import com.swufe.bluebook.CityChooseSlide.GlobalApp;
...
public abstract class BaseActivity extends AppCompatActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		mContext = this;
		GlobalApp.getInstance().mActivityStack.addActivity(this);
	...
	public void finish() {
		super.finish();
		GlobalApp.getInstance().mActivityStack.removeActivity(this);
	}
